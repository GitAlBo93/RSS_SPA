 ...
 */
//import { ICardInfo } from '../exportTS/export';
const cardsInfo = [
    {
        id: '1',
        name: 'Первая карточка',
        description: 'Полное и очень длинное описание для первой карточки',
    },
    {
        id: '2',
        name: 'Вторая карточка',
        description: 'Полное и очень длинное описание для второй карточки',
    },
    {
        id: '3',
